...
import CategoriesFilterForVideolessons from '~/components/elements/products/CategoriesFilterForVideolessons';
import PageContainer from '~/components/layouts/PageContainer';
import ProductByVideolessons from '~/components/partials/category/ProductByVideoLessons';
    ...
    return (
        <PageContainer
            ...
            <div className='ps-page--shop container'>
                <CategoriesFilterForVideolessons
                    breacrumb={fourChildData}
                    count={data?.count}
                    isLoading={isFourChildLoading}
                />
                <ProductByVideolessons
                    data={data}
                    page={page}
