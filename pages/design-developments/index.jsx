          ...
          <div className="ps-page-status">
              <div className="container">
                  <div className="ps-section__content">
                      ...
                      <p>
                        Bu sahifa grafik dizaynerlar va kreativ mutaxassislar uchun. Bu yerda dizayn shablonlari, bannerlar, logotiplar va boshqa grafik materiallarni topish mumkin. Hozircha ushbu kategoriyaga oid mahsulotlarni <Link href="/scientific-resources/template?parentCategory=template"><strong>"Ilmiy ishlar" bo‘limining "Tayyor shablonlar" bo‘limida</strong></Link> topishingiz mumkin. Tez orada ular tartibga solinib, ushbu bo‘limga joylashtiriladi. Yangi tuzilma yanada qulay va tushunarli bo‘ladi! 🚀
                      </p>
                      <p>
                          <Link href="/">
                              <a> Bosh sahifa</a>
