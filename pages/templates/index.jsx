          ...
          <div className="ps-page-status">
              <div className="container">
                  <div className="ps-section__content">
                      ...
                      <h3>Turli sohalar uchun shablonlar – Yangilanmoqda 🚧</h3>
                      <p>
                        Bu sahifa har qanday soha vakillari uchun. Bu yerda dizayn, biznes, ta’lim, IT va boshqa yo‘nalishlar uchun turli tayyor shablonlarni topish mumkin. Hozircha ushbu kategoriyaga oid mahsulotlarni <Link href="/scientific-resources/template?parentCategory=template"><strong>"Ilmiy ishlar" bo‘limining "Tayyor shablonlar" bo‘limida</strong></Link> topishingiz mumkin. Tez orada ular tartibga solinib, ushbu bo‘limga joylashtiriladi. Yangi tuzilma yanada qulay va tushunarli bo‘ladi! 🚀
                      </p>
                      <p>
                          <Link href="/">
                              <a> Bosh sahifa</a>
