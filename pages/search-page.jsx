    ...
    useEffect(() => {
        if (debouncedSearchTerm) {
            router.push({
                ...
                query: { ...router.query, keyword: debouncedSearchTerm, page: 1, type: 'all', tab: 'all', category},
            });
        }
