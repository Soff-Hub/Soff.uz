        ...
        <PageContainer
            ...
            <div className="ps-page--my-account">
                    ...
                    (products && <div className="d-flex container justify-content-center">
                        <div
                            ...
                            <div className="col-md-8 p-0">
                                {products?.poster_url ? '' : <button
                                    className="btn-success border-0 d-flex align-items-center"
                                    href={products?.document?.file_url}
                                    target='_blank'
                                    style={{ padding: '4px 8px', borderRadius: '6px' }}
                                    onClick={isLoading ? undefined : handleRegenerate}
                                >
                                    {isLoading ? <i className="fa-solid fa-arrows-rotate fa-spin-pulse fs-2 me-2"></i> : <i className="fa-solid fa-arrows-rotate fs-2 me-2"></i>}
                            ...
                            <form
                                        ...
                                        <div className='col-md-8 p-0'>
                                            <div
                                                ...
                                                <div
                                                    ...
                                                    {
                                                        products?.poster_url ? (
                                                            products?.document?.images?.map((item, i) => <img
                                                                className="mx-1 "
                                                                src={
                                                                    item?.image_url
                                                                }
                                ...
                                <div
                                    ...
                                    <button
                                        ...
                                        <span className="fs-4">
                                            <i class="fa-solid fa-forward me-2" style={{ transform: 'rotateY(180deg)' }}></i>
                                            Oldingisi{' '}
                                        </span>
                                    </button>
                                    <button
                ...
                <div
                    ...
                    aria-hidden="true">
                    <div className="modal-dialog container" style={{ maxWidth: '600px' }}>
