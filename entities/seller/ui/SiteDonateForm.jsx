...
import {
    ...
    formatExpiryDate,
} from '~/shared/utilities/ecomerce-helpers';
...
export default function SiteDonateForm() {
    ...
    const handleSubmit = async (e) => {
        ...
        if (
            (paymentStep === 'card' || paymentStep === 're-sms') &&
            ...
            try {
                ...
                if (err.response.data?.status?.[0] === 'False') {
                    ...
                    const modal = Modal.error({
                        ...
                        title: 'Xatolik!',
                        content:
                            err.response.data?.msg || "Qaytadan urinib ko'ring",
                    });
                    setPaymentStep('card');
                }
            }
                ...
                <div className="ps-tab active" id="register">
                    <form className="ps-form__content" onSubmit={handleSubmit}>
                        ...
                        <div className="amount-list d-flex gap-4 flex-wrap">
                            {[5000, 10000, 20000, 50000, 100000, 250000].map(
                                (el) => (
                                    <div
                                        key={el}
                        ...
                        {paymentMethod === 'by_card' &&
                            (paymentStep === 'sms' ||
                                ...
                                <div
                                    ...
                                    <div className="form-group flex-grow-1">
                                        <p>
                                            Raqamingizga yuborilgan sms kodni
                                            kiriting
                                        </p>
                                        <input
                                            className="form-control"
                                        ...
                                        {paymentStep === 're-sms' ? (
                                            ...
                                            <p>{timer} qayta kod olish uchun</p>
                                        )}
                                    </div>
                                </div>
                            )}
