...
export const useFPost = ({ url, token, onSuccess, onError, ...options } = {}) => {
...
export const useFPatch = ({ url, token, onSuccess, onError, ...options } = {}) => {
    const queryClient = useQueryClient();
    return useMutation({
        mutationFn: async (body) => {
...
export const useFDelete = ({ url, token, onSuccess, onError, ...options } = {}) => {
    const queryClient = useQueryClient();
    return useMutation({
        mutationFn: async (id) => {
