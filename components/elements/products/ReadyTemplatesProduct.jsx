...
const ReadyTemplatesProduct = ({ product }) => {
    console.log(product);
    ...
    function handleAddItemToWishlist (e) {
        ...
        if (wishlist?.find(item => item.id === ReadyTemplatesProduct?.id)) {
            removeSavedItemm(ReadyTemplatesProduct.id);
        }
    }
    ...
    return (
        <div>
            <div
                ...
                <div className=''>
                    <Link
                        href='/ReadyTemplatesProduct/[pid]'
                        as={`/ReadyTemplatesProduct/${ReadyTemplatesProduct.slug}`}
                        className=''>
                        <a>
                            {ReadyTemplatesProduct.poster_url ? (
                                thumbnailImage(ReadyTemplatesProduct)
                            ) : (
                                <img
...
export default ReadyTemplatesProduct;
