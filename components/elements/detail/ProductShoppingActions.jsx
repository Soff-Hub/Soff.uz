    ...
    return (
        <div>
            <div style={{ display: 'flex', alignItems: 'center', gap: '3px' }}>
                <p className='m-0 fs-2 py-1 px-4 text-black mr-auto' style={{ borderRadius: '20px', cursor: 'pointer', backgroundColor: '#F6F5F2', }}>{addPeriodToThousands(product?.price || 0)} so'm</p>
