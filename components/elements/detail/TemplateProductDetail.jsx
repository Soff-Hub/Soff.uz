        ...
        <div className="ps-product--detail ps-product--fullwidth">
            ...
            <div className="row pt-5">
                <h4
                    ...
                    style={{
                        fontFamily:
                            "PolySans, 'Inter', -apple-system, 'BlinkMacSystemFont', 'Segoe UI', 'Fira Sans', 'Helvetica Neue', 'Arial', sans-serif ",
                ...
                <div className="col-md-8 " id="get-buy">
                    <div
                        ...
                        <div
                            className="action-box d-flex flex-column gap-2"
                            style={{
                                position: 'absolute',
                                zIndex: 2,
                                right: 10,
                        ...
                        <TemplateProductThumbnail
                            data={[
                                { id: 0, url: product?.poster_url },
                                ...product?.document?.images?.map((el, i) => ({
                                    id: i + 1,
                                    url: el?.image_url,
                                })),
                            ]}
