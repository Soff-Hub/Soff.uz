    ...
    return (
        <div className="tolov-usullari">
            <div style={{ padding: "0 15px" }}>
                ...
                <p>Mahsulotni sotib olganingizdan so'ng   <a href="/account/sellerproducts" ><strong className='text-success'>Sotib olingan</strong></a> lar <br /> sahifasidan  yokida o'sha mahsulot ichida yuklab olish  <br /> tugmasi  chiqadi shu  orqali yuklab olishingiz mumkin!</p>
            </div>
