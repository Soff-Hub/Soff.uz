...
function ProductsLists () {
    ...
    for (let i = 0; i < dataPlayLists?.length; i++) {
        optionsPlayLists.push(
            <Option key={dataPlayLists[i].title}>
                {dataPlayLists[i].title}
            </Option>
        );
    }
    ...
    const columns = [
        {
            ...
            render: (poster_data, item) => (
                <div>
                    {item?.data_status?.status === 'deleted' ? (
                        ''
                        ...
                        <span
                            ...
                            onClick={() => getImageGeneration(poster_data?.id)}>
        ...
        },
        {
            ...
            render: view_count => (
                <span key={view_count} className='text-center'>
                    <i className='fa-solid fa-eye'></i> {view_count} ta
                </span>
            ),
        },
        {
            ...
            <Modal
                title={
                    deleteIdView?.document?.content_type === 'video'
                        ...
                        : deleteIdView?.document?.content_type === 'audio'
                        ? "Audio haqida to’liq ma'lumot"
                        : deleteIdView?.document?.content_type === 'template'
                        ? "Shablon haqida to’liq ma'lumot"
                              ...
                              'video' ? (
                                ...
                                <div className='ps-product--detail ps-product--fullwidth m-0'>
                                    <div className='ps-product__header '>
                                        {user.role === 'admin' &&
                                        deleteIdView?.document?.images?.length >
                                            0 ? (
                                            <ThumbnailDefault
                                                product={
                                                    deleteIdView
                                            ...
                                            <TabPane
                                                tab={
                                                    deleteIdView?.document
                                                        ?.content_type ===
                                                    'audio'
                                                        ? 'Audio to’liq tavsifi'
                                                        : deleteIdView?.document
                                                              ?.content_type ===
                                                          'video'
                                                        ? 'Video to’liq tavsifi'
                                                        : deleteIdView?.document
                                                              ?.content_type ===
                                                          'template'
                                                        ? 'Shablon to’liq tavsifi'
                                                        : 'Fayl to’liq tavsifi'
                                                }
                                                key='1'>
                                                <PartialDescription
            ...
            <Modal
                ...
                <div className='p-0 mt-5 mb-3 w-100 d-flex gap-4 flex-column'>
                    ...
                    <Select
                        ...
                        <Option key={'deleted'}>
                            {' '}
                            <i className='mr-2 fa-solid fa-trash text-danger'></i>{' '}
                            Arxivlangan
                        </Option>
                    </Select>
                    ...
                    <Select
                        ...
                        <Option value='all'>Barcha PlayListslar</Option>
