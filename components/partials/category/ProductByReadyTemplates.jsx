...
import ReadyTemplatesProduct from '~/components/elements/products/ReadyTemplatesProduct';

export default function ProductByReadyTemplates({ data = [], page, handlePagination, isLoading }) {
            ...
            <div className="row">
                {
                    data && (data?.results?.map((item, index) => (
                        <div
                            ...
                            key={item.id}>
                            <ReadyTemplatesProduct product={item} />
                        </div>
                    )))
                }
                {
