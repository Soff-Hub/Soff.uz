...
import VideolessonsProduct from '~/components/elements/products/VideolessonsProduct';

export default function ProductByVideolessons ({
    data = [],
    page,
    handlePagination,
    isLoading,
                ...
                {data &&
                    data?.results?.map((item, index) => (
                        <div
                            ...
                            key={item.id}>
                            <VideolessonsProduct product={item} />
                        </div>
                    ))}
                {isLoading && (
