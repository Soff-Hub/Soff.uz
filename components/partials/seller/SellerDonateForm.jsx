...
import { Form, Input, Tooltip, Switch, Modal } from 'antd';
                ...
                <div className="ps-tab active" id="register">
                    <form className="ps-form__content" onSubmit={handleSubmit}>
                        ...
                        <div className='d-flex align-items-center gap-3'>
                            ...
                            <div className="form-group">
                                ...
                                <Form.Item style={{ display: 'flex', alignItems: 'center' }}>
                                    <Switch onChange={onChange} style={name ? { backgroundColor: '#00A44F' } : {}} />
                                </Form.Item>
                            </div>
                        </div>
                        ...
                        <button
                            ...
                            className={`text-white ps-btn w-100 mt-3 mt-xl-0 mt-lg-0 mt-md-0 mt-sm-0 donate-color-btn`}
                        >
                            {' '}
