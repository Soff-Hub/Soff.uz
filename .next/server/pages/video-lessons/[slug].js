;{try{(function(){var e="undefined"!=typeof window?window:"undefined"!=typeof global?global:"undefined"!=typeof globalThis?globalThis:"undefined"!=typeof self?self:{},n=(new e.Error).stack;n&&(e._sentryDebugIds=e._sentryDebugIds||{},e._sentryDebugIds[n]="939cf72d-52c3-433d-a301-968ffcb51cdd",e._sentryDebugIdIdentifier="sentry-dbid-939cf72d-52c3-433d-a301-968ffcb51cdd");})();}catch(e){}};
"use strict";
(() => {
var exports = {};
exports.id = 2583;
...
function VideoLessons({ productsData , fourChildData , childCategoryData , parentCategory , childCategory , page ,  }) {
    ...
    const fullTitle = title && subTitle ? `${title} - ${subTitle}` : title ? title : "Video darsliklar";
...
async function getServerSideProps$1(context) {
    ...
    const productsUrl = `${_repositories_useApi__WEBPACK_IMPORTED_MODULE_5__/* .baseUrlUseApi */ .q}customer/products/?direction=video&category=${categoryParam}&page=${page}&page_size=50&search=${search}`;
    const fourChildUrl = `${_repositories_useApi__WEBPACK_IMPORTED_MODULE_5__/* .baseUrlUseApi */ .q}customer/four-child?direction=video`;
    const childCategoryUrl = `${_repositories_useApi__WEBPACK_IMPORTED_MODULE_5__/* .baseUrlUseApi */ .q}customer/four-child?direction=video&parent__slug=${parentCategory}`;
...
// on objects. Because the key that's used to index into this object (/video-lessons/[slug])
...
const getInitialPropsWrapper = getInitialPropsWrappers['/video-lessons/[slug]'] || _sentry_nextjs__WEBPACK_IMPORTED_MODULE_8__.wrapGetInitialPropsWithSentry;
...
const getStaticProps =
  typeof origGetStaticProps === 'function'
    ? _sentry_nextjs__WEBPACK_IMPORTED_MODULE_8__.wrapGetStaticPropsWithSentry(origGetStaticProps, '/video-lessons/[slug]')
    : undefined;
const getServerSideProps =
  typeof origGetServerSideProps === 'function'
    ? _sentry_nextjs__WEBPACK_IMPORTED_MODULE_8__.wrapGetServerSidePropsWithSentry(origGetServerSideProps, '/video-lessons/[slug]')
    : undefined;
...
var __webpack_exports__ = __webpack_require__.X(0, [676,1664,5675,5152,6017,8550,4747,1218,7567,9075,280,75,5419,6316,9410,6184,910,131], () => (__webpack_exec__(5771)));
