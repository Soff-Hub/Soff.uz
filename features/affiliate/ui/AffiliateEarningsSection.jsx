        ...
        <Card className="rounded-lg money_card shadow-md border">
            <div className="d-flex justify-content-center py-1 align-items-center flex-wrap gap-5">
                ...
                <div className="d-flex align-items-center gap-3">
                    ...
                    <div>
                        <div className="text-muted fw-medium">{earnings.affiliate_count} ta havola orqali daromad: <span className="fw-bold text-black">{formatCurrencyWithSpace(earnings.affiliate_wallet)} so'm</span></div>
                    </div>
                </div>
                ...
                <Button
                    onClick={() => {
                        message.info("Pulni yechib olish uchun hamyonda kamida 35.000 so'm bo'lishi kerak.", 5);
                    }}
                    type="primary"
